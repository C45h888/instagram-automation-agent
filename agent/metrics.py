...
============================
Single source of truth for all counters, histograms and gauges.
Imports ONLY from prometheus_client — no internal project imports.
Both services and routes import from here, eliminating circular deps.
"""
