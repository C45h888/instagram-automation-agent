...
def get_dm_history(business_account_id: str, customer_instagram_id: str, limit: int = 5) -> list:
    ...
    """
    return DMService.get_dm_history(customer_instagram_id, business_account_id, limit)
...
def get_dm_conversation_context(business_account_id: str, customer_instagram_id: str) -> dict:
    ...
    Args:
        ...
        customer_instagram_id: Instagram numeric ID of the DM sender (matches DB column customer_instagram_id)
    """
    return DMService.get_dm_conversation_context(customer_instagram_id, business_account_id)
